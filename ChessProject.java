...
*/
    ...
    */
    ...
    if(!(tmpy1 > 7)){
      if(checkSurroundingSquares(tmp1)){
        validM2 = new Move(startingSquare, tmp1, setScore(((tmp1.getXC()*75)+20), ((tmp1.getYC()*75)+20),x,y));
    ...
    if(!(tmpy2 < 0)){
      if(checkSurroundingSquares(tmp2)){
        validM3 = new Move(startingSquare, tmp2, setScore(((tmp2.getXC()*75)+20), ((tmp2.getYC()*75)+20),x,y));
  ...
  if(!((tmpx2 < 0))){
    ...
    if(!(tmpy1 > 7)){
      if(checkSurroundingSquares(tmp4)){
        validM2 = new Move(startingSquare, tmp4, setScore(((tmp4.getXC()*75)+20), ((tmp4.getYC()*75)+20),x,y));
    ...
    if(!(tmpy2 < 0)){
      if(checkSurroundingSquares(tmp5)){
        validM3 = new Move(startingSquare, tmp5, setScore(((tmp5.getXC()*75)+20), ((tmp5.getYC()*75)+20),x,y));
  ...
  if(!(tmpy1 > 7)){
    if(checkSurroundingSquares(tmp7)){
      validM2 = new Move(startingSquare, tmp7, setScore(((tmp7.getXC()*75)+20), ((tmp7.getYC()*75)+20),x,y));
  ...
  if(!(tmpy2 < 0)){
    if(checkSurroundingSquares(tmp8)){
      validM3 = new Move(startingSquare, tmp8, setScore(((tmp8.getXC()*75)+20), ((tmp8.getYC()*75)+20),x,y));
  ...
  */
  ...
  for(int j=1;j < 8;j++){
    ...
    if(!(tmpx1 > 7 || tmpx1 < 0)){
      ...
      validM2 = new Move(startingSquare, tmp2, setScore(((tmp2.getXC()*75)+20), ((tmp2.getYC()*75)+20),x,y));
      if(!piecePresent(((tmp2.getXC()*75)+20), (((tmp2.getYC()*75)+20)))){
        moves.push(validM2);
      }
      else{
  ...
  for(int k=1;k < 8;k++){
    ...
    if(!(tmpy3 > 7 || tmpy3 < 0)){
      ...
      validM3 = new Move(startingSquare, tmp3, setScore(((tmp3.getXC()*75)+20), ((tmp3.getYC()*75)+20), x, y));
      if(!piecePresent(((tmp3.getXC()*75)+20), (((tmp3.getYC()*75)+20)))){
        moves.push(validM3);
      }
      else{
  ...
  for(int l=1;l < 8;l++){
    ...
    if(!(tmpy4 > 7 || tmpy4 < 0)){
      ...
      validM4 = new Move(startingSquare, tmp4, setScore(((tmp4.getXC()*75)+20), ((tmp4.getYC()*75)+20), x, y));
      if(!piecePresent(((tmp4.getXC()*75)+20), (((tmp4.getYC()*75)+20)))){
        moves.push(validM4);
      }
      else{
  ...
  */
  ...
  for(int k=1;k < 8;k++){
    ...
    if(!(tmpk > 7 || tmpk < 0 || tmpy2 > 7 || tmpy2 < 0)){
      ...
      validM2 = new Move(startingSquare, tmpK1, setScore(((tmpK1.getXC()*75)+20), ((tmpK1.getYC()*75)+20), x, y));
  ...
  for(int l=1;l < 8;l++){
    ...
    if(!(tmpL2 > 7 || tmpL2 < 0 || tmpy3 > 7 || tmpy3 < 0)){
      ...
      validM3 = new Move(startingSquare, tmpLMov2, setScore(((tmpLMov2.getXC()*75)+20), ((tmpLMov2.getYC()*75)+20), x, y));
  ...
  for(int n=1;n < 8;n++){
    ...
    if(!(tmpN2 > 7 || tmpN2 < 0 || tmpy4 > 7 || tmpy4 < 0)){
      ...
      validM4 = new Move(startingSquare, tmpNmov2, setScore(((tmpNmov2.getXC()*75)+20), ((tmpNmov2.getYC()*75)+20), x, y));
...
private Stack getKnightMoves(int x, int y, String piece){
  ...
  for(int i=0;i < 8;i++){
    ...
    Move tmpmove = new Move(startingSquare, tmp, setScore(((tmp.getXC()*75)+20), ((tmp.getYC()*75)+20), x, y));
...
public int setScore(int x, int y, int lastX, int lastY){
  ...
  try{
    ...
    }else if(tmp1.contains(color+"Bishop")||tmp1.contains(color+"Knight")){
  ...
  System.exit(0);
    ...
    */
      ...
      while(!completeMoves.empty()){
        ...
        System.out.println("The "+s1.getName()+" can move from ("+s1.getXC()+", "+s1.getYC()+") to the following square: ("+s2.getXC()+", "+s2.getYC()+")" + s1.getScore()+score);
        testing.push(tmpMove);
      }
       System.out.println("=============================================================");
       Border redBorder = BorderFactory.createLineBorder(Color.RED, 3);
       Move selectedMove = agent.SelectedStrategy(strategy, testing, black);
